...
const TUTORIAL_PAGES = [
  { title: '欢迎使用摩迪司机端', body: '在这里您可以接单、上报定位，方便乘客找到您。' },
  { title: '如何接单', body: '在首页点击「设为空闲可接客」即可进入接单状态，乘客将能看到您的位置。' },
  { title: '定位上报', body: '请定期上报定位，以便乘客看到您的实时位置。' },
  { title: '注意事项', body: '请先完成身份认证后再接单；接单后请及时联系乘客。' },
  { title: '开始使用', body: '教程结束，请完成身份认证后即可接单。' },
];
